...
// FindImage inline display: an image a tool produced (theo_find_image), streamed as `event: vault_image`
...
export type View = "chats" | "overview" | "projects" | "project" | "artifacts" | "customize";
