...
| 5 | CHANGED — `src/theo/useTheoState.ts` (the cold-open restore effect: fresh<4h → restore last chat; stale>4h / no recent chat → `applyView("overview")`) | `Read` + `Edit` this turn | base @HEAD `f0cacff307564ea5b206b2727e66268aaddee08f` → proposed `d62ed195da37020b4e323ad87962378422e73341` |
