...
| 9 | **MODIFIED HANDLER (deployed base) — `dottie_message_stream`** (Responses API) | `Read`(full) this turn; `Codex Governance/Dottie-D2-Stream-Backend-Pass-1-VEP/proposed-app/src/functions/dottie_message_stream.js` | base `30b36560675772bbf02cd3af066e1613bd424811` (pre-change) |
| 10 | **MODIFIED HANDLER (deployed base) — `dottie_message`** (chat/completions) | `Read`(full) this turn; `Codex Governance/Dottie-D2-Conversation-Handlers-Pass-1-VEP/dottie_message.index.js` | base `bb21440b37e1fc35434290774acdf9740cfb83f7` (pre-change) |
